...
pub fn decode(raw: u32) -> Instr {
    ...
    match opcode {
        ...
        0x2f => {
            ...
            match (funct5, funct3) {
                (0x02, 2) if rs2 == 0 => Instr::LrW {
                    rd,
                    rs1,
                    _aq: aq,
                    _rl: rl,
                },
                (0x02, 3) if rs2 == 0 => Instr::LrD {
                    rd,
                    rs1,
                    _aq: aq,
                    _rl: rl,
